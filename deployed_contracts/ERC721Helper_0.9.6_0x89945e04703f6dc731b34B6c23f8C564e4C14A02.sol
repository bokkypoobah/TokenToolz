...
// ----------------------------------------------------------------------------
// ERC-721 Helper v0.9.6
//
// https://github.com/bokkypoobah/TokenToolz
//
// Deployed to Mainnet 0x89945e04703f6dc731b34B6c23f8C564e4C14A02
//
...
contract ERC721Helper {
    ...
    function hasERC20BalanceOf(address _token, address _tokenOwner) internal view returns (bool) {
        bool success;
    ...
    function hasERC20Symbol(address _token) internal view returns (bool) {
        bool success;
    ...
    function hasERC20Name(address _token) internal view returns (bool) {
        bool success;
